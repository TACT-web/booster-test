...
SUBJECT_PROMPTS = {
    "英語": """以下の指示に従い、必ずHTML形式のタグを使用して出力してください。

【1. 凡例（必ず改行）】
冒頭に『凡例』を作成してください。各行の末尾に <br> を入れて必ず改行してください。
- 🟢 :green[ / ] ： 主語・動詞の区切り<br>
- 🔵 :blue[ / ] ： 目的語の間（SVOO）<br>
- 🔴 :red[ / ] ： 補語の間（SVOC）<br>
- 🟡 :orange[ / ] ： 前置詞・修飾語の前<br>
...
【3. メイン解説（必ず表形式）】
以下のHTML構造を参考にして、必ず「表」で出力してください。
<table border='1'>
  <tr><th>英文（構造可視化）</th><th>意味の塊</th><th>理由・文法</th></tr>
  <tr><td>例: I :green[ / ] live :orange[ / ] in Tokyo.</td><td>私は / 住んでいます / 東京に。</td><td>スラッシュの根拠</td></tr>
</table>

【4. まとめ】
最後に『文法の要点まとめ』と『全文意訳』を記載。
